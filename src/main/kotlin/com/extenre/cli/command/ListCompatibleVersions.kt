...
import com.extenre.library.PackageName
import com.extenre.library.VersionMap
import com.extenre.library.mostCommonCompatibleVersions
...
@CommandLine.Command(
    ...
    description = [
        "List the most common compatible versions of apps that are compatible " +
            "with the patches from EXRE files.",
    ],
)
