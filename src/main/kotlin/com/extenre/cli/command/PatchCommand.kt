...
import com.extenre.library.installation.installer.*
import com.extenre.library.setOptions
...
internal object PatchCommand : Runnable {
    ...
    internal class Selection {
        ...
        internal class EnableSelection {
            ...
            internal class EnableSelector {
                ...
                @CommandLine.Option(
                    names = ["--ei"],
                    description = ["Index of the patch in the combined list of the supplied EXRE files."],
                    required = true,
                )
    ...
    private var keyStoreEntryAlias = "ExtenRe Key"
    ...
    @CommandLine.Option(
        names = ["-p", "--patches"],
        description = ["One or more path to EXRE files."],
        required = true,
    )
    @Suppress("unused")
